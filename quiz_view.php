...
<body>
	...
	<div class="container-fluid admin">
		...
		<button class="btn btn-primary bt-sm" id="new_question"><i class="fa fa-plus"></i>	Adicionar Questões</button>
		<button class="btn btn-primary bt-sm" id="new_student"><i class="fa fa-plus"></i>	Adicionar Aluno</button>
		<br>
		<br>
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Adicionar Nova Questão</h4>
						...
						<form id='question-frm'>
							<div class ="modal-body">
								...
								<div class="form-group">
									...
									<span>
									<label><input type="radio" name="is_right[0]" class="is_right" value="1"> <small>Resposta</small></label>
									</span>
									<br>
									<textarea rows="2" name ="question_opt[1]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[1]" class="is_right" value="1"> <small>Resposta</small></label>
									<br>
									<textarea rows="2" name ="question_opt[2]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[2]" class="is_right" value="1"> <small>Resposta</small></label>
									<br>
									<textarea rows="2" name ="question_opt[3]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[3]" class="is_right" value="1"> <small>Resposta</small></label>
								</div>
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Adicionar Novo Estudante/s</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
						<form id='student-frm'>
							<div class ="modal-body">
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp != undefined){
						...
						$('#manage_question .modal-title').html('Editar Questão')
						$('#manage_question').modal('show')
