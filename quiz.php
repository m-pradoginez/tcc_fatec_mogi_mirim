...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Lista de Questionários</div>
		<button class="btn btn-primary bt-sm" id="new_quiz"><i class="fa fa-plus"></i>	Novo</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
							 <a class="btn btn-sm btn-outline-primary edit_quiz" href="./quiz_view.php?id=<?php echo $row['id']?>"><i class="fa fa-task"></i> Gerenciar</a>
							 <button class="btn btn-sm btn-outline-primary edit_quiz" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Editar</button>
							<button class="btn btn-sm btn-outline-danger remove_quiz" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i> Deletar</button>
							</center>
						</td>
					</tr>
					<?php
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Adicionar Novo Questionário</h4>
...
<script>
	$(document).ready(function(){
		...
		$('#new_quiz').click(function(){
			$('#msg').html('')
			$('#manage_quiz .modal-title').html('Adicionar Novo Questionário')
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp != undefined){
						...
						$('#manage_quiz .modal-title').html('Editar Questionário')
						$('#manage_quiz').modal('show')
